...
class FuseNet(nn.Module):
    def __init__(self, nStack, nModules, nFeats, nJoint):
        ...
        self.fc1 = nn.Linear(JOINT_POS_LEN+IMU_NUM*4,JOINT_POS_LEN+IMU_NUM*4)
        self.fc2 = nn.Linear(JOINT_POS_LEN+IMU_NUM*4,JOINT_POS_LEN+IMU_NUM*4)
        self.fc3 = nn.Linear(JOINT_POS_LEN+IMU_NUM*4,JOINT_POS_LEN)
        self.fc4 = nn.Linear(JOINT_POS_LEN,JOINT_POS_LEN)
